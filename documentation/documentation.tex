...
\usepackage{graphicx, wrapfig, float, enumitem, hyperref, chngcntr, ragged2e}
...
\centering
\includegraphics[width=0.5\textwidth]{images/DC40mm5V} \label{DC40mm5V}
\caption{Ventilator} 
\end{wrapfigure}
...
\begin{figure}[H]
\centering
	\includegraphics[width=0.6\textwidth]{images/pwm}\label{pwm}
	\caption{Primer povećanja faktora ispune u PWM signalu}
\end{figure}
\pagebreak
...
\begin{figure}[H]
\centering
\rotatebox{270}{\includegraphics[scale=0.5]{images/circuit_diagram}} \label{circuit_diagram}
\end{figure}
