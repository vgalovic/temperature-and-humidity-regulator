...
% Define constants
\pgfmathsetmacro{\J}{0.000000807}
\pgfmathsetmacro{\b}{0.000000414}
\pgfmathsetmacro{\K}{0.0059}
\pgfmathsetmacro{\R}{1.72}
\pgfmathsetmacro{\L}{0.000106}
...
\addplot[mark=*, color=red] coordinates{(0.1497, 731.2692)} node[pin=-30:{$t_{s} = 0.1497$s}]{};
\draw [dashed,help lines, color=red] (0,731.2692) -| (0.1497,0);

\end{axis}
\end{tikzpicture}
\end{center}			
\caption{Odziv koraka}\label{grafiik:step_response}
\end{grafik}
