...
\addplot[no marks, color=blue] table[x=Humidity, y=Time]{tests/humidity/test1.txt};

\addlegendentry{Voda: 35.0 °C}
\addplot[no marks,  color=red] table[x=Humidity, y=Time]{tests/humidity/test2.txt};

\addlegendentry{Voda: 45.0 °C}
\addplot[no marks,  color=green] table[x=Humidity, y=Time]{tests/humidity/test3.txt};

\addlegendentry{Voda: 55.0 °C}
\addplot[no marks,  color=purple] table[x=Humidity, y=Time]{tests/humidity/test4.txt};
